...
<section class="antialiased bg-gray-100 text-gray-600 h-screen">
    <div class="flex justify-end pt-6 pr-3">
        <a href="{{route('reading.create')}}"><p class="bg-sky-500 text-white px-3 py-2 font-semibold rounded-lg">Create Reading</p></a>
    </div>
    ...
    <div class="flex flex-col justify-center">
        ...
        <div class="w-full mt-8 max-w-4xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-800">Reading</h2>
            </header>
            <div class="p-3">
                    ...
                    <table class="table-auto w-full" id="data_table">
                        <thead class=" font-semibold uppercase text-gray-400 bg-gray-50">
                            <tr>
                                ...
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-left">View Transection</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium text-green-500">
                                            <a href="{{route('reading.show',$data->id)}}">
